...
from accounts.views.change_pass import ChangePass
from accounts.views.login import Login
from accounts.views.register import Register
from accounts.views.activation import EmailActivation
from accounts.views.email_verify import EmailVeriy